...
public class LoweringVisitorTests
{
    ...
    public void Lowering_ShouldBranch_WithLoop()
    {
        ...
        AssertTransition.AssertGoto( result.Scopes[0].Nodes[4].Transition, "ST_0001" ); // BF WAS ST_0003
        AssertTransition.AssertGoto( result.Scopes[0].Nodes[5].Transition, "ST_0002" ); // BF WAS ST_0003
