...
| **Hyperbee.Expressions.Compiler** | A high-performance, IR-based expression compiler that is 8-28x faster than the System compiler with correct IL across all expression tree patterns. |
...
that is **8-28x faster and allocates 31-52% less than the System compiler** and supports **all expression 
tree patterns**.
