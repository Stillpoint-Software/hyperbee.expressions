...
public class AsyncBlockExpression2 : Expression
{
    ...
    internal AsyncBlockExpression2( Expression body )
    {
    ...
    public class AsyncBlockExpressionProxy( AsyncBlockExpression2 node )
    {
        public Expression Body => node._body;
    }

    public static AsyncBlockExpression2 BlockAsync( BlockExpression expression )
    {
        ...
        return new AsyncBlockExpression2( expression );
    }
