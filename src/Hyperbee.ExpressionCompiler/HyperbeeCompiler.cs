...
/// <summary>
/// High-performance IR-based expression compiler. Drop-in replacement for Expression.Compile().
/// </summary>
public static class HyperbeeCompiler
{
    ...
    public static Delegate Compile( LambdaExpression lambda )
        => throw new NotImplementedException( "Hyperbee.ExpressionCompiler is not yet implemented." );
